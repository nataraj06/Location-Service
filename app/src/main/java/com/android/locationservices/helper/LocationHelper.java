package com.android.locationservices.helper;
...
/**
 * Created by Nataraj Sharan on 10/12/18.
 */
public class LocationHelper implements LocationListener {
    /**
     * Constant used in the location settings dialog.
     */
    public static final int REQUEST_CODE_RESOLVABLE_API = 0x6;
    ...
    public void onActivityResult(int requestCode, int resultCode) {
        switch (requestCode) {
            ...
            case REQUEST_CODE_RESOLVABLE_API:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        Toast.makeText(context,
                                "User agreed to make required location settings changes.", Toast.LENGTH_LONG).show();
                        break;
                    case Activity.RESULT_CANCELED:
                        ...
                        Toast.makeText(context,
                                "User choose not to make required location settings changes.", Toast.LENGTH_LONG).show();
                        break;
                }
                break;
        }
    ...
    public interface OnLocationCompleteListener {
        ...
        void onResolvableApiResponseFailure();
    }
}
